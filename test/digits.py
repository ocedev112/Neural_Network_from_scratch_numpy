...
y_train = [[1 if i == label else 0 for i in range(10)] for label in y_raw[:split]]
y_test = [[1 if i == label else 0 for i in range(10)] for label in y_raw[split:]]

nn = NeuralNetwork(64, [(128, "LeakyReLU"), (64, "LeakyReLU"), (10, "Softmax")])
